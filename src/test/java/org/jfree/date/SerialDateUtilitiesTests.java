...
public class SerialDateUtilitiesTests {
    ...
    public void testDayCountActual() {
        final SerialDate d1 = SerialDateImpl.createInstance(1, Month.APRIL, 2002);
        final SerialDateImpl d2 = SerialDateImpl.createInstance(2, Month.APRIL, 2002);
    ...
    public void testDayCount30() {
        final SerialDate d1 = SerialDateImpl.createInstance(1, Month.APRIL, 2002);
        final SerialDate d2 = SerialDateImpl.createInstance(2, Month.APRIL, 2002);
    ...
    public void testDayCount3030E() {
        SerialDate d1 = SerialDateImpl.createInstance(1, Month.APRIL, 2002);
        SerialDate d2 = SerialDateImpl.createInstance(2, Month.APRIL, 2002);
    ...
    public void testCountFeb29s_onOneDay() {
        SerialDate start = SerialDateImpl.createInstance(29, Month.FEBRUARY, 2000);
        SerialDate end = SerialDateImpl.createInstance(29, Month.FEBRUARY, 2000);
    ...
    public void testCountFeb29s_inAFewDays() {
        SerialDate start = SerialDateImpl.createInstance(1, Month.FEBRUARY, 2000);
        SerialDate end = SerialDateImpl.createInstance(29, Month.APRIL, 2000);
    ...
    public void testCountFeb29s_inAFewYears() {
        SerialDate start = SerialDateImpl.createInstance(1, Month.FEBRUARY, 2000);
        SerialDate end = SerialDateImpl.createInstance(29, Month.APRIL, 2010);
