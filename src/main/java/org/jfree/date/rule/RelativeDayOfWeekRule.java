...
public class RelativeDayOfWeekRule extends AnnualDateRule {
    ...
    private AnnualDateRule dateRule;
     ...
     *                  or following).
     */
    public RelativeDayOfWeekRule(final AnnualDateRule subRule, int dayOfWeek, final int relative) {
     ...
     * Sets the sub-rule.
     *
     * @param dateRule  the annual date rule that determines the reference date
     *                 for this rule.
     */
    public void setDateRule(final AnnualDateRule dateRule) {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        duplicate.dateRule = (AnnualDateRule) duplicate.getDateRule().clone();
        return duplicate;
    }
